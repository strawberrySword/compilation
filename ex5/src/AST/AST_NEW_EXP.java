...
public class AST_NEW_EXP extends AST_EXP {
	...
	public TEMP IRme() {
		if (isNewArray) {
			TEMP len_temp = len.IRme();
			IR.getInstance().Add_IRcommand(new IRCommand_NewArray(len_temp));
		}
		// TODO
		// TEMP src = exp.IRme();
		// IR.getInstance().Add_IRcommand(new IRcommand_Store(((AST_VAR_SIMPLE)
		// var).name, src));
